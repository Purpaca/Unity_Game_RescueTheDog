using UnityEngine;
using List = System.Collections.Generic.List<UnityEngine.RectTransform>;
...
public class SafeAreaAdaptor : MonoBehaviour
{
    ...
    private Vector2 GetOffsetMin()
    {
        ...
        offsetMin.x = -canvas.GetComponent<RectTransform>().rect.width / 2 * GameManager.Instance.UserSettingsData.SafeAreaOffsetLeft;
        offsetMin.y = -canvas.GetComponent<RectTransform>().rect.height / 2 * GameManager.Instance.UserSettingsData.SafeAreaOffsetDown;
    ...
    private Vector2 GetOffsetMax()
    {
        ...
        offsetMax.x = canvas.GetComponent<RectTransform>().rect.width / 2 * GameManager.Instance.UserSettingsData.SafeAreaOffsetRight;
        offsetMax.y = canvas.GetComponent<RectTransform>().rect.height / 2 * GameManager.Instance.UserSettingsData.SafeAreaOffsetUp;
