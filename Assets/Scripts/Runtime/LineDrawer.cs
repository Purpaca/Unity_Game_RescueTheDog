...
using List_Vector3 = System.Collections.Generic.List<UnityEngine.Vector3>;
...
public class LineDrawer : MonoBehaviour
{
    ...
    private OnDrawEndEvent m_onDrawEnd = new OnDrawEndEvent();
    ...
    private List_Vector3 _points = new();
    ...
    /// 当线绘制完成事件
    /// </summary>
    public OnDrawEndEvent OnDrawEnd 
    {
        get => m_onDrawEnd;
        set => m_onDrawEnd = value;
    }
    #endregion
    ...
    #region 内部类型
    [System.Serializable]
    public class OnDrawEndEvent : UnityEvent<GameObject> { }
    #endregion
}